...
const divIcon = function (shapeDefactorDeciderInpetuoVeryImportant) {
	const elOtro = shapeDefactorDeciderInpetuoVeryImportant;
	if (shapeDefactorDeciderInpetuoVeryImportant > 1.2) {
		return <div className='iconito' style={cssStyles(2)} />;
	} else if (shapeDefactorDeciderInpetuoVeryImportant <= 1.2) {
		const shape = cssStyles(4);
		return (
			<div className='iconito' style={cssStyles(3)}>
				<div style={cssStyles(5)}>
					<div style={shape} />
					<div style={shape} />
				</div>
				<div style={cssStyles(5)}>
...
const cssStyles = function (tipo) {
	const speed1 = Math.round(Math.random() * 120) + 30;
	const speed2 = Math.round(Math.random() * 25) + 5;
	if (tipo == 1) {
		return {
			height: "100%",
			width: "100%",
		...
		return {
			...
			left: "" + Math.random() * 80 + "%",
			top: "" + Math.random() * 95 + 10 + "%",
			borderRadius: Math.floor(Math.random() * 1.9) * 100 + "%",
			animation: "spin-icon infinite " + speed2 + "s linear",
		};
	} else if (tipo == 3) {
		return {
			left: "" + Math.random() * 80 + "%",
